...
var localLife = (function() {
	...
	var sql_msgtable = 'CREATE TABLE IF NOT EXISTS local_botMsg(id INTEGER PRIMARY KEY,userid VARCHAR, msgid VARCHAR,askid VARCHAR, askname VARCHAR,asktel VARCHAR, devid VARCHAR,devname VARCHAR,dsc VARCHAR,msgJsonStrData VARCHAR,createtime VARCHAR)';
