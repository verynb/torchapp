...
(function ($) {
    ...
    var scroller = (function () {
        ...
        scrollerCore.prototype = {
            ...
            refreshContent: "请上拉更新",
            refreshHangTimeout: 400,//时间过短会导致下拉后不能回收 ymkadun-2016/1/6
            refreshHeight: 60,
            refreshElement: null,
            ...
            init: function (el, opts) {
                ...
                var orientationChangeProxy = function () {
                    ...
                    if (that.eventsActive && !$.feat.nativeTouchScroll&&(!$.ui || ($.ui.activeDiv === that.container)) ) {
                        //that.adjustScroll(); ymkadun-2016/1/6
                    }
                };
