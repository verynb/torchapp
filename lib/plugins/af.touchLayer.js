...
//    var focusScrolls = $.os.ios; //devices scrolling on focus instead of resizing
    ...
    var touchLayer = function(el) {
        ...
        $.bind(this, "scrollstart", function(el) { //console.log("touchLayer开始：scrollstart");
        ...
        $.bind(this, "scrollend", function(el) { //console.log("touchLayer开始：scrollend");
...
//              this.onTouchMove(e);
//              break;
//          case "touchend": //console.log("touchLayer：触发touchend");
//              this.onTouchEnd(e);
//              if($.os.ios) break;
//          case "click": console.log("touchLayer：触发click");
//              this.onClick(e);
//              if($.os.ios) break;
//          case "blur": console.log("touchLayer：触发blur");
//              this.onBlur(e);
//              if($.os.ios) break;
//          case "scroll": console.log("touchLayer：触发scroll");
//              this.onScroll(e);
//              if($.os.ios) break;
//          case "orientationchange": //console.log("touchLayer：触发orientationchange");
//              this.onOrientationChange(e);
//              if($.os.ios) break;
//          case "resize": //console.log("touchLayer：触发resize");
//              this.onResize(e);
//              if($.os.ios) break;
//          case "focusin": console.log("touchLayer：触发focusin");
//              this.onFocusIn(e);
//              if($.os.ios) break;
//          }
//      },
        ...
        onTouchMove: function(e) {
            ...
            if ((!$.os.blackberry10&&!this.requiresNativeTap)) {
                ...
                if (!this.isScrolling || (!$.feat.nativeTouchScroll&&!this.requiresNativeTap)){
                    if(!G_POPUPSHOW){ //ymkadun-2016/1/6
                        e.preventDefault();
                    }
                }
                return;
